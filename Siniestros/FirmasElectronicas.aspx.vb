...
Partial Class Siniestros_FirmasElectronicas
    ...
    Private Function ConsultaOrdenesPago() As DataTable
        ...
        If IsDate(txtFechaGeneracionDesde.Text) And IsDate(txtFechaGeneracionHasta.Text) Then
            If CDate(txtFechaGeneracionDesde.Text) <= CDate(txtFechaGeneracionHasta.Text) Then
                FiltroFechaGen = " AND CONVERT(VARCHAR(10),fec_generacion,112) >= ''" & CDate(txtFechaGeneracionDesde.Text).ToString("yyyyMMdd") & "'' AND CONVERT(VARCHAR(10),fec_generacion,112) <= ''" & CDate(txtFechaGeneracionHasta.Text).ToString("yyyyMMdd") & "''"
            End If
        End If
        ...
        If IsDate(txtFechaPagoDesde.Text) And IsDate(txtFechaPagoHasta.Text) Then
            If CDate(txtFechaPagoDesde.Text) <= CDate(txtFechaPagoHasta.Text) Then
                FiltroFechaPago = " AND CONVERT(VARCHAR(10),fec_pago,112) >= ''" & CDate(txtFechaPagoDesde.Text).ToString("yyyyMMdd") & "'' AND CONVERT(VARCHAR(10),fec_pago,112) <= ''" & CDate(txtFechaPagoHasta.Text).ToString("yyyyMMdd") & "''"
            End If
        End If

        If IsNumeric(txtMontoDesde.Text) Then
            FiltroMonto = " AND imp_total >= " & txtMontoDesde.Text
        End If

        If IsNumeric(txtMontoHasta.Text) Then
            FiltroMonto = FiltroMonto & " AND imp_total <= " & txtMontoHasta.Text
        End If

        'JJIMENEZ
        'If chk_Devolucion.Checked = True Then
        '    FiltroNatOP = " AND ( sn_devolucion = -1 " & IIf(chk_ConISR.Checked = False And chk_SinISR.Checked = False, " )", "")
        'End If

        'If chk_ConISR.Checked = True Then
        '    FiltroNatOP = FiltroNatOP & IIf(chk_Devolucion.Checked = False, " AND ( ", " OR ") & " ISNULL(Impuesto,0) <> 0 " & IIf(chk_SinISR.Checked = False, " )", "")
        'End If

        'If chk_SinISR.Checked = True Then
        '    FiltroNatOP = FiltroNatOP & IIf(chk_Devolucion.Checked = False And chk_ConISR.Checked = False, " AND ( ", " OR ") & " ISNULL(Impuesto,0) = 0 )"
        'End If

        If chk_Pendiente.Checked = True And chk_Autorizada.Checked = False Then
            intTipoFirma = 0
        ElseIf chk_Pendiente.Checked = False And chk_Autorizada.Checked = True Then
            intTipoFirma = 1
        End If

        'intFirmas = CInt(chk_Solicitante.Checked) +
        '            CInt(chk_JefeDirecto.Checked) * 2 +
        '            CInt(chk_SubDirector.Checked) * 4 +
        '            CInt(chk_Director.Checked) * 8 +
        '            CInt(chk_DirectorGral.Checked) * 16 +
        '            CInt(chk_Tesoreria.Checked) * 32 '+
        ' CInt(chk_Contabilidad.Checked) * 64
    ...
    Private Sub btn_BuscaOP_Click(sender As Object, e As EventArgs) Handles btn_BuscaOP.Click
        Try
            If cmbModuloOP.SelectedValue > 0 Then
                ...
                'Funciones.LlenaGrid(grdOrdenPago, ConsultaOrdenesPago)
    ...
    Private Function fn_Autorizaciones(ByVal sn_rechazo As Boolean) As Boolean
        Dim strOP As String = ""
        ...
        '    NvA = grdOrdenPago.DataKeys(row.RowIndex)("NivelAutorizacion")
        '    usu = grdOrdenPago.DataKeys(row.RowIndex)("Solicitante")
        'Next
        ...
        For Each row In dtAutorizaciones.Rows
            ...
            If row("NivelAutorizacion") = 1 Then
                ...
                Else
                    If DirectCast(grdOrdenPago.Rows(contador).FindControl("chkFirmaJefe"), CheckBox).Checked = False Then
            ...
            ElseIf row("NivelAutorizacion") = 2 Then
                If DirectCast(grdOrdenPago.Rows(contador).FindControl("chkFirmaSolicitante"), CheckBox).Checked = False Then
                    UsuarioFirma = row("Solicitante")
                Else
                    If DirectCast(grdOrdenPago.Rows(contador).FindControl("chkFirmaSubgerente"), CheckBox).Checked = False Then
            ...
            ElseIf row("NivelAutorizacion") = 3 Then
                If DirectCast(grdOrdenPago.Rows(contador).FindControl("chkFirmaSolicitante"), CheckBox).Checked = False Then
                    UsuarioFirma = row("Solicitante")
                Else
                    If DirectCast(grdOrdenPago.Rows(contador).FindControl("chkFirmaSubdirector"), CheckBox).Checked = False Then
            ...
            ElseIf row("NivelAutorizacion") = 4 Then
                ...
                Else
                    If DirectCast(grdOrdenPago.Rows(contador).FindControl("chkFirmaSubdirector"), CheckBox).Checked = False Then
                        UsuarioFirma = row("Subdirector")
                    Else
                        If DirectCast(grdOrdenPago.Rows(contador).FindControl("chkFirmaDirector"), CheckBox).Checked = False Then
                ...
                Else
                    ...
                    Else
                        If DirectCast(grdOrdenPago.Rows(contador).FindControl("chkFirmaDirector"), CheckBox).Checked = False Then
                            UsuarioFirma = row("Director")
                        Else
                            If DirectCast(grdOrdenPago.Rows(contador).FindControl("chkFirmaDirectorGeneral"), CheckBox).Checked = False Then
    ...
    Protected Sub chk_Rechazo_CheckedChanged(sender As Object, e As EventArgs)
        Try
            ...
            If sender.checked = True Then
                ...
                TryCast(grdOrdenPago.Rows(gr.RowIndex).FindControl("lnk_SelMotivo"), LinkButton).Visible = True
            Else
                TryCast(grdOrdenPago.Rows(gr.RowIndex).FindControl("lnk_SelMotivo"), LinkButton).Visible = False
            End If
    ...
    Private Sub DesHabilitaChecksFirma()
        For Each row In grdOrdenPago.Rows
            ...
            Dim chk_FirmaDirGral = DirectCast(row.FindControl("chk_FirmaDirGral"), CheckBox)
            Dim chk_Teso = DirectCast(row.FindControl("chk_FirmaTeso"), CheckBox)
            ...
            If grdOrdenPago.DataKeys(row.RowIndex)("sn_firma_solicita") = 1 Then
                chkSol.Enabled = False
                chk_Urgente.Enabled = False
                chk_Financiado.Enabled = False
            End If

            If grdOrdenPago.DataKeys(row.RowIndex)("sn_firma_jefe") = 1 Then
            ...
            If grdOrdenPago.DataKeys(row.RowIndex)("sn_firma_subdirector") = 1 Then
                chkSubDir.Enabled = False
                lnk_SelJefe.Enabled = False
                lnk_SelJefe.ForeColor = Drawing.Color.Gray

                If grdOrdenPago.DataKeys(row.RowIndex)("sn_firma_director") = 1 Or grdOrdenPago.DataKeys(row.RowIndex)("sn_firma_tesoreria") = 1 Then
                    lnk_SelSubDir.Enabled = False
                    lnk_SelSubDir.ForeColor = Drawing.Color.Gray
                End If
            End If

            If grdOrdenPago.DataKeys(row.RowIndex)("sn_firma_director") = 1 Then
                chkDir.Enabled = False
                chk_AutorizaDireccion.Enabled = False
            End If

            If grdOrdenPago.DataKeys(row.RowIndex)("sn_firma_director_gral") = 1 Then
                chk_FirmaDirGral.Enabled = False
                chk_AutorizaDirectorGral.Enabled = False
            End If

            If grdOrdenPago.DataKeys(row.RowIndex)("sn_firma_tesoreria") = 1 Then
            ...
            If grdOrdenPago.DataKeys(row.RowIndex)("sn_firma_contabilidad") = 1 Then
            ...
            If grdOrdenPago.DataKeys(row.RowIndex)("sn_firma_rechazo") = 1 Then
                chkRech.Enabled = False
                chkJefe.Enabled = False
                chkSubDir.Enabled = False
                chkDir.Enabled = False
    ...
    Private Sub btn_Imprimir_Click(sender As Object, e As EventArgs) Handles btn_Imprimir.Click
        ...
        Try
            ...
            For Each row In grdOrdenPago.Rows
                ...
                If TryCast(row.FindControl("chkImpresion"), CheckBox).Checked Then
    ...
    Private Sub btn_Todas_Click(sender As Object, e As EventArgs) Handles btn_Todas.Click
        ...
        Try
            ...
            For Each row In grdOrdenPago.Rows
                TryCast(row.FindControl("chkImpresion"), CheckBox).Checked = True
            Next
    ...
    Private Sub btn_Ninguna_Click(sender As Object, e As EventArgs) Handles btn_Ninguna.Click
        ...
        Try
            ...
            For Each row In grdOrdenPago.Rows
                TryCast(row.FindControl("chkImpresion"), CheckBox).Checked = False
            Next
