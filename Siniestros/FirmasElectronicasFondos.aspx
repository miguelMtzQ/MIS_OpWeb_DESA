                                                        ...
                                                        <div class="row" style="border-style: inset; border-width: 1px;">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4 Centro">
                                                                    ...
                                                                    <asp:LinkButton runat="server" ID="lnk_SelDir" Text='<%# Eval("NombreDirector") %>' Width="100%" OnClick="lnk_SelJefe_Click" Visible='<%# Eval("NivelAutorizacion") >= 4  %>'></asp:LinkButton>
                                                                ...
                                                                <div class="col-md-4 Centro">
                                                                    ...
                                                                    <asp:LinkButton runat="server" ID="lnk_SelSubGnt" Text='<%# Eval("NombreSubgerente") %>' Width="100%" OnClick="lnk_SelJefe_Click" Visible='<%# Eval("NivelAutorizacion") = 2  %>'></asp:LinkButton>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4 Centro">
                                                                    ...
                                                                    <asp:LinkButton runat="server" ID="lnk_SelSubDir" Text='<%# Eval("NombreSubdirector") %>' Width="100%" OnClick="lnk_SelJefe_Click" Visible='<%# Eval("NivelAutorizacion") >= 3 %>'></asp:LinkButton>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4 Centro">
                                                                    ...
                                                                    <asp:LinkButton runat="server" ID="lnk_SelDirGral" Text='<%# Eval("NombreDirectorGeneral") %>' Width="100%" OnClick="lnk_SelJefe_Click" Visible='<%# Eval("NivelAutorizacion") >= 5  %>'></asp:LinkButton>
