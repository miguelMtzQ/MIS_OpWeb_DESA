<%@ Page Title="" Language="VB" MasterPageFile="~/Pages/SiteMaster.master" AutoEventWireup="false" CodeFile="CancelacionOpsFondos.aspx.vb" Inherits="Siniestros_CancelacionOpsFondos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_principal" Runat="Server">
    ...
    <div class="zona-principal" style="overflow-x:hidden;overflow-y:hidden">
        <div class="cuadro-titulo panel-encabezado">
            ...
            Filtros - Cancelación de Ordenes de Pago Fondos
        </div>
